...
import com.pathshala.schedule.syllabus.fileuploaddownload.service.FileDataService2;

import lombok.RequiredArgsConstructor;

@RestController
@RequestMapping("/apinew/filestorage")
@RequiredArgsConstructor
public class FileDataStorageController2 {
	
	private final FileDataService2 storageService;
		...
		List<ResponseData> fileInfos = storageService.loadAll()
							.map(path -> {
								...
								String url = MvcUriComponentsBuilder
										.fromMethodName(
												FileDataStorageController2.class,
												"download",
